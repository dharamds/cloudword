...
class Webperformance extends MX_Controller {
    ...
    public function check($project_id = NULL){
        ...
        if(!empty($prodata)){
            ...
            $this->load->view("admin/project/webperformance", $data);
        }else{
    ...
    public function seo_check($project_id = NULL){
        ...
        if(!empty($prodata)){
            ...
            $this->load->view("admin/project/seo_check", $data);
        }else{
            redirect(base_url('admin/project'));
        }
    }
    ...
    public function get_urls(){
        ini_set('maximum_input_vars',1000000);
        ini_set('max_execution_time', -1);
        ...
        if($a->length > 0){
            ...
            //print_r($altername_links); exit;
              $seoanalytics["totalpagerequest"] = $totalpagerequest; 
              $seoanalytics["totalpagesize"] = $totalpagesize; 
              //$seoanalytics["altername_links"]=  $this->unique_array($altername_links, 'url');
