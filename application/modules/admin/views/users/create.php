		...
		<div class="col-md-12">
			<div class="filter-container flex-row">
				<div class="flex-col-6">
					<h3 class="filter-content-title"><?= $this->lang->line("create_new_user");?></h3>
				</div>
									...
									<div class="card-block">
										<form id="userCreateForm" method="post">
											...
											<div class="form-group row">
												...
												<label class="col-sm-2 col-form-label  text-right"><?= $this->lang->line("email_id");?><span class="text-danger">*</span> </label>
												<div class="col-sm-4">
											...
											<div class="form-group row">
												...
												<div class="col-sm-4">
													<textarea id="landmark"  name="landmark" class="form-control" placeholder=""></textarea>
													<span style="color: red;" class="landmark_msg errmsg"></span>
												</div> -->
											...
											<fieldset class="border p-2">
												...
												<div class="form-group row">
													<div class="col-sm-12">
														<input type="checkbox" name="check_company" id="check_company" onclick="showcompany_block();"> <?= $this->lang->line("user_company_sure");?>
													</div>	
												</div>
												<div class="form-group row">
											...
											<fieldset class="border p-2">
												<h3><?= $this->lang->line("user_roles");?><span class="text-danger">*</span></h3>
   												<hr>
												<div class="form-group row">
													<div class="col-sm-12">
														...
														<label class="radio-inline">
															<input type="radio" id="user_role" name="user_role" onclick="checkforreseller(this.value)"  value="<?= $rl->role_id ?>" > <?= $this->lang->line($rl->role_name); ?> 
														</label>
															<?php
														}
														?>
   										...
   										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input type="text" name="userscount" id="userscount" placeholder="<?= $this->lang->line("no_of_users")?>" class="form-control userscount chkreseller" readonly>
										...
										<div class="form-group row">
												...
												<div class="col-sm-4">
													<input type="text" value="<?= $plandata->ftp_space_limit ?? '' ?>" placeholder="<?= $this->lang->line("ftp_space_limit")?>" name="ftp_space_limit" id="ftp_space_limit" class="form-control userscount chkreseller" readonly/>
													<span style="color: red;" class="ftp_space_limit_msg"></span>
												</div>
												<div class="col-sm-4">
													<?php $ftp_unit = $plandata->ftp_unit ?? 0; ?>
													<select id="ftp_unit" name="ftp_unit" class="form-control chkreseller" readonly>
											...
											<div class="form-group row">
												...
												<div class="col-sm-4">
													<input type="text" value="<?= $plandata->sql_space_limit ?? '' ?>" placeholder="<?= $this->lang->line("db_space_limit")?>" name="sql_space_limit" id="sql_space_limit" class="form-control userscount chkreseller" readonly/>
													<span style="color: red;" class="sql_space_limit_msg"></span>
												</div>
												<div class="col-sm-4">
													<?php $db_unit = $plandata->db_unit ?? 0; ?>
													<select id="db_unit" name="db_unit" class="form-control chkreseller" readonly>
	...
	$("#userCreateForm").on('submit', function(e){
		...
		if(intRegex.test(zipcode) || floatRegex.test(zipcode)) {
		   ...
		   alert('I am a number');
			...
			alert('I am a not number');
		}
		*/
		
    	$.ajax({
           url:"<?php echo base_url();?>admin/users/save/create",
           type:"post",
           beforeSend:function(){
           		$("#cover-spin").show()
           },
