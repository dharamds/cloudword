							...
							<tbody>
								...
								foreach($backups as $bkp) {
									...
									<tr>
										...
										<td align="center"><?= $bkp->file_name ?$bkp->file_name: "-" ?></td>
										<td><?php
										...
										<td>
											<?php if($bkp->status == "success"){

												?>
											<a style="margin:5px;min-width: 40px;" href="javascript:" class="btn btn-primary waves-effect waves-light" onclick='restorebkptest(<?=$bkp->backup_id;?>)' data-toggle="tooltip" data-placement="top" title='<?= $this->lang->line("restore_bkp")?>'><i class="flaticon-backup-2"></i><!-- <?= $this->lang->line("restore_bkp")?> --></a>
											
											<a style="margin:5px;min-width: 40px;" href="javascript:" class="btn btn-primary waves-effect waves-light"  data-toggle="tooltip" data-placement="top" title='<?= $this->lang->line("del_bkp")?>' onclick='deletebkp(<?=$bkp->backup_id;?>)'><i class="flaticon-delete-2"></i></a>

											<a style="margin:5px;min-width: 40px;" href="<?=base_url()?>admin/backup/downloadftp/<?=$bkp->backup_id;?>" class="btn btn-primary waves-effect waves-light" data-toggle="tooltip" data-placement="top" title='<?= $this->lang->line("download")?>'><?= $this->lang->line("download")?> </a>
											<?php
											}else{
												?>
												<a style="margin:5px;min-width: 40px;" data-toggle="tooltip" data-placement="top" title='Check live status' href="javascript:" class="btn btn-primary waves-effect waves-light" onclick='checklivestatus(<?php echo $bkp->foldersdata; ?> )'><i class="flaticon-speedometer-1"></i></a>
												<?php
											}
											?>
											<!-- <a style="margin:5px;" href="javascript:" class="btn btn-xs btn-info" onclick='restorebkptest(<?=$bkp->backup_id;?>)'> test </a> -->
...
function startbkprestore(bkp_id){
	...
	function restorebkp(bkp_id){
		...
		.then((value) => {
			...
			if(value == 'catch'){
				$.ajax({
					url:"<?php echo base_url();?>admin/backup/restore",
					method:"post",
					 beforeSend:function(){
					           		$("#cover-spin").show()
					           },
	...
	function deletebkp(bkp_id){
		...
		.then((value) => {
			if(value == 'catch'){
				$.ajax({
					url:"<?php echo base_url();?>admin/backup/delete",
					method:"post",
					 beforeSend:function(){
					           		$("#cover-spin").show()
					           },
