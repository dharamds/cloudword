...
<body style="background-image:url('<?php echo base_url();?>public/public/front/img/banner-bg.png');">
    <div class="form-body" style="background-image:url('<?php echo base_url();?>public/public/front/img/banner-bg.png');">
        <div class="row ">
            ...
            <div class="form-content">                  
                <div class="form-items">
                  <div class="form-title-holder">
                    <h2 class="title"><?php echo $this->lang->line("admin_login")?></h2>
                ...
                <form id="login_form" onsubmit="return validate();" action="<?php echo base_url();?>admin/login/login_set" method="post">
