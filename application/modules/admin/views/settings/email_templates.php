		...
		<div class="col-md-12">
			<div class="filter-container flex-row">
				<div class="flex-col-md-6">
					<h3 class="filter-content-title"><?=$this->lang->line("email_template_setting")?></h3>
				</div>
						...
						<table id="memListTable" class="table table-bordered table-striped table-hover datatable" cellspacing="0">
							...
							<tbody>
								...
								if(count($email_templates) > 0){
									$cnt = 1;
									foreach ($email_templates as $set){				
										?>
										<tr>
											<td><?= $cnt ?></td>
											<td><?= ucfirst($set->temp_code) ?></td>
											<td><?= $set->subject?></td>
											<td>
												<a style="min-width: 40px;" data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-primary" href="<?= base_url('admin/settings/email_templates/edit/').$set->id ?>"><i class="flaticon-edit"></i> </a>
											</td>
										</tr>
										<?php
										$cnt++;
