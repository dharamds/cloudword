		...
		<div class="col-md-12">
			<div class="filter-container flex-row">
				<div class="flex-col-md-6">
					<h3 class="filter-content-title"><?= $this->lang->line("edit_email_template");?></h3>
				</div>
								...
								<div class="card">
									<div class="card-block">
										...
										<form id="editForm" method="post">
											...
											<input type="hidden" name="template_id" value="<?= $email_templates->id ?>">

											<fieldset class="border p-2">
	   											<h3> <?= $this->lang->line("edit_email_template");?> </h3>
	   											<hr>

	   											<div class="form-group row">
													<label class="col-sm-4 col-form-label"><?= $this->lang->line("subject");?><span class="text-danger">*</span> </label>
													<div class="col-sm-4">
														<input type="text" class="form-control" value="<?= $email_templates->subject ?>" name="subject" required>
														<span style="color: red;" class="errmsg"></span>
													</div>
												</div>

												<div class="form-group row">
													<label class="col-sm-4 col-form-label"><?= $this->lang->line("shortcodes");?> </label>
													<div class="col-sm-6">
														<?php foreach ($shortcodes as $key => $value): ?>
															<span><code><?= $key ?></code> : <?= $value ?> </span><br>
														<?php endforeach ?>
													</div>
												</div>
												...
												<div class="form-group row">
													...
													<div class="col-sm-12">
														<textarea class="form-control ckeditor" name="message" id="message"><?= !empty($email_templates->message) ? $email_templates->message : '' ?></textarea>
												...
												<div class="form-group row">
													<div class="input-group">
														...
														<div class="col-sm-6 text-right">
															<a href="<?= base_url('admin/settings/email_templates') ?>" class="btn btn-default waves-effect"><?= $this->lang->line("close");?></a>
...
<script type="text/javascript">
	...
	$("#editForm").on('submit', function(e){
    	...
    	$.ajax({
			url:"<?php echo base_url();?>admin/settings/email_templates/update",
			type:"post",
            ...
            success:function(data){
                ...
                if(data.status == "success"){
                    swal(data.msg, {
						...
						window.location.replace("<?= base_url()?>/admin/settings/email_templates");
					})
