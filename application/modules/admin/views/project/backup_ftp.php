    ...
    <div class="row mr-0">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?= base_url('admin/project/manage_backup/'.base64_encode($ftp_server_details->project_id))?>"><?=$this->lang->line("backups") ?></a></li>
                      ...
                      <div id="memListTable_wrapper" class="form-inline no-footer">
                        <div class="row">
                            ...
                            <div class="col-sm-7 ftpbtn">
                             ...
                             <a class="btn btn-primary" href="<?=base_url("admin/backup/restore_process/".$ftp_server_details->ftp_id)?>" ><?=$this->lang->line("restore_process") ?></a>
                          ...
                          <table id="backuplist" class="table table-bordered table-striped table-hover datatable dataTable no-footer" cellspacing="0" role="grid" aria-describedby="memListTable_info">
                            <thead>
                              <tr role="row">
                               ...
                               <th style="width: 53px;" class="sorting" tabindex="0" aria-controls="memListTable" rowspan="1" colspan="1" aria-label="Status : activate to sort column ascending"><?=$this->lang->line("last_backup_time") ?> </th>
      ...
      $('[data-toggle="tooltip"]').tooltip({container: 'body'});
          ...
          var dttt =  $('#backuplist').DataTable({
              ...
              'processing': true,
                ...
                'serverMethod': 'post',
                'ajax': {
                   'url':'<?=base_url()?>admin/project/getftp_ajax',
                   'data': function(data){
  ...
  function viewlogs(backup_id){
    if($("#bkpmodal_id").val() == ""){
        $("#bkpmodal_id").val(backup_id);
                     ...
                     $.ajax({
                            url:"<?php echo base_url();?>admin/project/backuplogs",
                            type:"post",
                            beforeSend:function(){
                               $("#cover-spin").show()
                            },
            ...
            var chk = "<?php echo $this->lang->line("Are you sure to start restore now")?>";
              swal(chk,{
                  ...
                  switch (value) {
                    ...
                    case "catch":
                        $.ajax({
                             url:"<?php echo base_url();?>admin/project/putftprestorecron",
                             type:"post",
                             beforeSend:function(){
                                $("#cover-spin").show()
                             },
