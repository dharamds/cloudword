         ...
         <div class="col-md-12">
            <div class="filter-container flex-row">
               ...
               <div class="flex-col-md-6 text-right">
                  <!-- <a class="btn btn-primary" href="http://devdemo.pro/cloud_world/admin/projects/create"> New Project </a> --> 
               </div>
            </div>
         </div>
      </div>
                           ...
                           <div class="panel-body no-padding p-0">
                              <div id="memListTable_wrapper" class=" form-inline no-footer">
                                 <div class="row">
                                    ...
                                    <div class="col-xs-6 text-right ftpbtn"> <a class="btn btn-primary" href="<?= base_url('admin/project/add_ftp/'.$project_data->project_id) ?>" ><?= $this->lang->line("add_newftp")?></a> </div>
                                 </div>
                                    ...
                                    <table id="ftpservertable" class="table table-bordered table-striped table-hover datatable dataTable no-footer" cellspacing="0" role="grid" aria-describedby="memListTable_info">
                                       ...
                                       <tbody>
                                            ...
                                            <td class="sorting_1"><?= $cnt ?></td>
                                             ...
                                             <td>
                                                <a href="<?= base_url('admin/project/backup_ftp/'.$ftps->ftp_id) ?>" class="btn btn btn-primary"><?= $this->lang->line("manage")?></a>
                                                
                                                <a href="<?= base_url('admin/project/edit_ftp/'.base64_encode($ftps->ftp_id)) ?>" class="btn btn-primary" style="min-width:40px" data-toggle="tooltip" data-placement="top" title="Edit"><i class="flaticon-pencil-1"></i></a>
                           ...
                           <div class="panel-body no-padding p-0">
                              <div id="memListTable_wrapper" class=" form-inline no-footer">
                                 <div class="row">
                                    ...
                                    <div class="col-lg-6 text-right ftpbtn"> <a class="btn btn-primary" href="<?= base_url('admin/project/add_db/'.$project_data->project_id) ?>" ><?= $this->lang->line("add_new_db")?></a> </div>
                                 </div>
                                    ...
                                    <table id="dbservertable" class="table table-bordered table-striped table-hover datatable dataTable no-footer" cellspacing="0" role="grid" aria-describedby="memListTable_info">
                                       ...
                                       <tbody>
                                          <?php
                                             ...
                                             <td>
                                                <a href="<?= base_url('admin/project/backup_db/'.$dbs->mysql_id) ?>" class="btn btn btn-primary"><?= $this->lang->line("manage")?></a>
                                                <a href="<?= base_url('admin/project/edit_db/'.base64_encode($dbs->mysql_id)) ?>" class="btn btn-primary" style="min-width:40px" data-toggle="tooltip" data-placement="top" title="Edit"><i class="flaticon-pencil-1"></i></a>
              ...
              swal(chk, {
                ...
                .then((value) => {
                  switch (value) {
                    ...
                    case "catch":
                        $.ajax({
                             url:"<?php echo base_url();?>admin/project/update_daily_status",
                             type:"post",
                             beforeSend:function(){
                                $("#cover-spin").show()
                             },
              ...
              swal(chk, {
                ...
                .then((value) => {
                  switch (value) {
                    ...
                    case "catch":
                        $.ajax({
                             url:"<?php echo base_url();?>admin/project/update_daily_status_db",
                             type:"post",
                             beforeSend:function(){
                                $("#cover-spin").show()
                             },
    ...
    swal(chk, {
      ...
      .then((value) => {
        switch (value) {
          ...
          case "catch":
              $.ajax({
                   url:"<?php echo base_url();?>admin/project/deleteftp",
                   type:"post",
                   beforeSend:function(){
                      $("#cover-spin").show()
                   },
    ...
    swal(chk, {
      ...
      .then((value) => {
        switch (value) {
          ...
          case "catch":
              $.ajax({
                   url:"<?php echo base_url();?>admin/project/deletedb",
                   type:"post",
                   beforeSend:function(){
                      $("#cover-spin").show()
                   },
   ...
   swal(chk, {
     ...
     .then((value) => {
       switch (value) {
         ...
         case "catch":
             $.ajax({
                  url:"<?php echo base_url();?>admin/project/putftpcron",
                  type:"post",
                  beforeSend:function(){
                     $("#cover-spin").show()
                  },
    ...
    swal(chk, {
      ...
      .then((value) => {
        switch (value) {
          ...
          case "catch":
              $.ajax({
                   url:"<?php echo base_url();?>admin/project/putdbcron",
                   type:"post",
                   beforeSend:function(){
                      $("#cover-spin").show()
                   },
