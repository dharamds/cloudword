...
<div class="container-fluid">
	<div class="row mr-0">
		<nav aria-label="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?= base_url('client/project/manage_backup/'.$project_data->project_id)?>"><?=$this->lang->line("backups") ?></a></li>
											...
											<div style="margin-top:30px">
												<form class="addftp" id="addftpform" enctype="multipart/form-data">
													...
													<div class="row">
														...
														<div class="col-lg-7">
															<input type="text" class="form-control" name="remote_folder" id="f_password" placeholder="/public_html">
														</div>
													</div>
													<div class="row">
