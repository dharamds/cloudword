		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="<?= base_url('admin/project')?>"><?=$this->lang->line("projects") ?></a></li>
          		<li class="breadcrumb-item"><a href="<?= base_url('admin/project/'.$project_data->project_id)?>"><?=$this->lang->line("backups") ?></a></li>
...
$(function () {
	...
	$("#editdbform").on('submit', function(e){
    	...
    	$.ajax({
			url:"<?php echo base_url(); ?>admin/project/update_db",
			type:"post",
			beforeSend:function(){
				$("#cover-spin").show()
			},
