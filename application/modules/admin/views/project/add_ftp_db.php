...
<span class="tooltip" title="<?=$this->lang->line("select_excluded_directory") ?>" style="opacity: 1;"><img src="<?php echo base_url('assets/images/icons8-help-50.png');?>"> </span>
													...
													<div class="row">
														<div class="col-lg-9 text-right">
															<a href="<?=base_url('admin/project/manage_backup/'.$project_data->project_id) ?> " class="btn btn-secondary" ><?=$this->lang->line("cancel") ?></a>
										...
										<div id="memListTable_wrapper" class="dataTables_wrapper form-inline no-footer">
											...
											<div style="margin-top:30px">
												<form class="addftp" id="adddbform">
													...
													<div class="row">
														<label for="d_caption" class="col-lg-2 col-form-label"><?=$this->lang->line("caption") ?><span class="text-danger">*</span></label>
														<div class="col-lg-7">
													...
													<div class="row">
														<label for="d_hostname" class="col-lg-2 col-form-label"><?=$this->lang->line("hostname") ?><span class="text-danger">*</span></label>
														<div class="col-lg-3">
...
<span class="tooltip" title="<?=$this->lang->line("white_list_CW_server_IP") ?>" style="opacity: 1;"><img src="<?php echo base_url('assets/images/icons8-help-50.png');?>"> </span>
														...
														<label for="d_port_no" class="col-lg-1 col-form-label"><?=$this->lang->line("port_no") ?><span class="text-danger">*</span></label>
														<div class="col-lg-1">
...
<span class="tooltip" title="<?=$this->lang->line("please_enter_custom_port_db") ?>" style="opacity: 1;"><img src="<?php echo base_url('assets/images/icons8-help-50.png');?>"> </span>
													...
													<div class="row">
														<label for="d_username" class="col-lg-2 col-form-label"><?=$this->lang->line("username") ?><span class="text-danger">*</span></label>
														<div class="col-lg-7">
															<input type="text" class="form-control" name="username" id="d_username" placeholder="<?=$this->lang->line("username") ?>" required>
														</div>
													</div>
													<div class="row">
														<label for="d_password" class="col-lg-2 col-form-label"><?=$this->lang->line("password") ?><span class="text-danger">*</span></label>
														<div class="col-lg-7">
															<input type="password" class="form-control" name="password" id="d_password" placeholder="******" required>
														</div>
													</div>
													<div class="row">
														<div class="col-lg-9 text-right">
...
$(function () {
	...
	$("#addftpform").on('submit', function(e){
	    e.preventDefault();
		$.ajax({
	       url:"<?php echo base_url(); ?>admin/project/save_ftp",
	       type:"post",
	       beforeSend:function(){
	       		$("#cover-spin").show()
	       },
	...
	$("#adddbform").on('submit', function(e){
		...
		$.ajax({
	      url:"<?php echo base_url(); ?>admin/project/save_db",
	       type:"post",
	       beforeSend:function(){
	       		$("#cover-spin").show()
	       },
