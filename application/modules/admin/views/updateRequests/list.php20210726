...
$(document).ready(function() {
	...
	$('#reqform').submit(function (e) {
		...
		$.ajax({
           url:"<?php echo base_url();?>admin/updateRequest/update",
           type:"POST",
           data : formdata,
           processData : false,
           contentType : false,
    	...
    	$('.sizeConvert').change(function (e) {
    		...
    		$.ajax({
	           url:"<?php echo base_url();?>admin/updateRequest/getFormat",
	           type:"POST",
	           data : {
	           		unit,
	           		size_in_bytes,
...
function deleteRequest(request_id){
	...
	.then((confirmValue) => {
		if(confirmValue == 'catch'){
			$.ajax({
	           url:"<?php echo base_url();?>admin/updateRequest/delete/"+request_id,
	           type:"get",
	           beforeSend:function(){
	           		$("#cover-spin").show()
	           },
