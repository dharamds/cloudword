...
<html lang="en">
    <head>
        ...
        <!-- loader css -->
        <link type="text/css" href=" <?php echo base_url();?>public/public/assets/css/loader_css.css" rel="stylesheet">
        ...
        <script type="text/javascript" src=" <?php echo base_url('public/admin/assets/js/');?>common.js"></script>
...
<script type="text/javascript">
    $("#cpasswordform").on('submit', function(e){
            ...
            if(cpasswordverify == ""){
                ...
                $.ajax({
                    url:"<?php echo base_url();?>admin/users/change_password",
                    type:"post",
     ...
     function change_language(langvar){
        $.ajax({
           url:"<?php echo base_url();?>admin/dashboard/change_language",
           type:"post",
            ...
            .then((value) => {
              switch (value) {
                case "defeat":
                  ...
                  break;
                case "catch":
                 location.replace("<?= base_url('admin/login/logout') ?>");
                  break;
                default:
                 return false;
              }
    ...
    <header id="topnav" class="navbar navbar-default navbar-fixed-top" role="banner">
        ...
        <ul class="nav navbar-nav toolbar pull-right">
            ...
            <li class="dropdown toolbar-icon-bg select_language">
                <a href="javascript:" onclick="logout_admin()" data-toggle="tooltip" title="<?php echo $this->lang->line("sign_out")?>"><i style="color: white;"  class="flaticon-logout"></i></a>
            </li>
