...
<body style="background-image:url('<?php echo base_url();?>public/public/front/img/banner-bg.png');">
    <div class="form-body">
            ...
            <div class="form-content">                  
                <div class="form-items">
                  <div class="form-title-holder">
                    <h2 class="title"><?php echo $this->lang->line("reset_password");?></h2>
                </div>
        ...
        <?php }else{ ?>
            <div class="text-center"><p> <?php echo $this->lang->line("This link is expired, please make new request to reset password.")?></p></div>
        <?php } ?>    
    ...
    $("#resetpassword_form").validate({
			rules: {
				'username': {
					required: true,
					remote   : {
                        url:"<?php echo base_url();?>client/login/getCheckUserNameExist",
					 	type: 'POST',
        ...
        var submitForm = function (){ 
            $('.message').html('');
            $.ajax({
                url:"<?php echo base_url();?>client/login/get_change_password",
                method: "POST",
                ...
                success: function (result) {
                    if(result.code == 200)
                    {
                        ...
                        setTimeout(function(){ window.location.href = "<?php echo base_url();?>client/login" }, 4000);
                    }else{
                        //$(".loader").hide();
