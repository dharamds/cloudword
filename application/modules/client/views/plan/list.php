		...
		<div class="col-md-12">
			<div class="filter-container flex-row">
				...
				<div class="flex-col-6 text-right">
					<a class="btn btn-primary" href="<?php echo base_url();?>client/plan/add">
								...
								<?php
									...
									foreach ($planlist as $plan){				
										...
										<tr>
											...
											<td><a class="btn btn-primary" href="<?php echo base_url();?>client/plan/add/<?= $plan->id; ?>?type=view" ><i class="flaticon-view"></i></a>
												<a style="min-width: 40px;" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Edit"  href="<?php echo base_url();?>client/plan/add/<?= $plan->id; ?>" ><i class="flaticon-edit"></i></a>
	...
	function deleteplan(plan_id){
		...
		.then((confirmValue) => {
			if(confirmValue == 'catch'){
				$.ajax({
		           url:"<?php echo base_url();?>client/plan/delete/"+plan_id,
		           type:"get",
		           beforeSend:function(){
		           		$("#cover-spin").show()
		           },
