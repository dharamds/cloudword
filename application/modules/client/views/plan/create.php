		...
		<div class="col-md-12">
			<div class="filter-container flex-row">
				<div class="flex-col-6">
					<h3 class="filter-content-title"><?= !empty($id) ? $this->lang->line("edit_plan") : $this->lang->line("add_new_plan")?></h3>
				</div>
							...
							<div class="col-sm-8 col-sm-offset-3">
								<div class="card">
									<div class="card-block">
										<form id="planaddform" action="<?= base_url();?>client/plan/add/<?= $id ?>" method="post" enctype="multipart/form-data">
											...
											<div class="form-group row">
												...
												<div class="col-sm-3">
													<input type="text" value="<?= $plandata->ftp_space_limit ?? '' ?>" placeholder="<?= $this->lang->line("ftp_space_limit")?>" name="ftp_space_limit" class="form-control userscount" />
												</div>
												<div class="col-sm-3">
													<?php $ftp_unit = !empty($plandata->ftp_unit) ? $plandata->ftp_unit : 'false'; 
													?>
											...
											<div class="form-group row">
												...
												<div class="col-sm-3">
													<input type="text" value="<?= $plandata->sql_space_limit ?? '' ?>" placeholder="<?= $this->lang->line("db_space_limit")?>" name="sql_space_limit" class="form-control userscount"/>
												</div>
												<div class="col-sm-3">
													<?php $db_unit = !empty($plandata->db_unit) ? $plandata->db_unit : 'false'; ?>
											...
											<div class="form-group row">
												...
												<div class="col-sm-6">
													<input type="text" value="<?= $plandata->price ?? '' ?>" placeholder="<?= $this->lang->line("price")?>" name="price" class="form-control userscount"/>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-3 col-form-label"><?= $this->lang->line("time_period")?><span class="text-danger">*</span></label>
												<div class="col-sm-3">
											...
											<div id="additinalInfoBox">
												...
												?>		
													<div class="form-group row" id="infoboxrow<?php echo $count; ?>">
														...
														<button type="button" onclick="removeAddInfoRow(<?php echo $count; ?>)" style="color:red;"><i class="flaticon-trash"></i></button>
													</div>	
												<?php
													$count++;	
													} 
											...
											<div class="form-group row">
												<div class="col-sm-9 text-right">
													<button type="button" id="addMoreInfoBtn" class="btn btn-primary btn-xs"><?= $this->lang->line("add_more")?></button>
												</div>
											</div>
											<div class="form-group row">
												<div class="input-group">
													<div class="col-sm-6 text-right">
														<button type="button" class="btn btn-default waves-effect" onclick="backToList()"><?php echo $this->lang->line("close")?></button>
...
<script type="text/javascript">
	...
	messages: {
    	...
    	ftp_unit:{
		required: "<?= $this->lang->line("ftp_unit")?>",
    	},
    	db_unit:{
		required: "<?= $this->lang->line("db_unit")?>",
    	},	
		price:{
	...
	function backToList() {
		window.location.replace("<?= base_url()?>client/plan");
	}
