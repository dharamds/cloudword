								...
								<?php
									...
									foreach ($userapi as $val){				
										...
										<tr>
											...
											<td>
												<a href="javascript:" class="btn btn-primary" style="min-width: 40px;" onclick='updateproj(<?php echo json_encode($val);?>)'> <i class="flaticon-pencil-1"></i></a>
											</td>
										</tr>
										<?php
									}
								...
								<div class="card-block">
									<form id="apiform" method="post">
										...
										<div class="form-group row">
											<label class="col-sm-3 col-form-label"><?= $this->lang->line("api_key")?></label>
											<div class="col-sm-9">
