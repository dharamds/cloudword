									...
									<div class="card-block">
										<form id="userCreateForm" method="post" enctype="multipart/form-data">
											...
											<div class="form-group row" align="center">
												...
												<?php if(empty($getclient->img)){
													?>
													<img height="100" width="100" src="<?= base_url() ?>public/public/assets/img/default_user.png" id="userprofile" name="userprofile">
												<?php	
												}else{
													?>
													<img height="100" width="100" src="<?= base_url() ?>uploads/user/profile/thumbnail/<?=$getclient->img?>" id="userprofile" name="userprofile">
													<?php
												}
												?>
											...
											<div class="form-group row">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control" name="email" id="email" placeholder="<?= $this->lang->line("Email");?>" value="<?= $getclient->email?>">
											...
											<div class="form-group row">
												...
												<?php
												$bbb = '';
												if(!empty($getclient->birth)){
													$bb = explode("-",$getclient->birth);
													$bbb=$bb[1]."/".$bb[2]."/".$bb[0];	
												}
												?>
												<div class="col-sm-4">
													<input type="date" id="dob"  name="dob" class="form-control" placeholder="<?= $this->lang->line("Date_of_Birth"); ?>" value="<?= $bbb ?>">
											...
											<div class="form-group row">
												<div class="input-group">
													...
													<div class="col-sm-6 text-right">
														...
														<a href="<?=base_url('client/dashboard') ?>" class="btn btn-default waves-effect" data-dismiss="modal"><?= $this->lang->line("close");?></a>
													</div>
												</div>
											</div>
										</form>
...
<script type="text/javascript">
	...
	$("#userCreateForm").on('submit', function(e){
        e.preventDefault();
    	$.ajax({
           url:"<?php echo base_url();?>client/users/update_profile",
           type:"post",
           beforeSend:function(){
           		$("#cover-spin").show()
           },
