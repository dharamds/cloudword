...
<script type="text/javascript">
  ...
  function get_htmllinks(){
            ...
            $.ajax({
                   url:"<?php echo base_url(); ?>client/webperformance/get_urls",
                   type:"post",
                   beforeSend:function(){
  ...
  function get_imagelinks(){
            var url = "<?php echo $url;?>";
            $.ajax({
                   url:"<?php echo base_url(); ?>client/webperformance/get_images",
                   type:"post",
                   beforeSend:function(){
  ...
  function get_jslinks(){
            var url = "<?php echo $url;?>";
            $.ajax({          
                   url:"<?php echo base_url(); ?>client/webperformance/get_jss",
                   type:"post",
                   beforeSend:function(){
                      $("#jsbody_loader").show()
                   },
  ...
  function get_csslinks(){
            var url = "<?php echo $url;?>";
            $.ajax({
                   url:"<?php echo base_url(); ?>client/webperformance/get_css",
                   type:"post",
                   beforeSend:function(){
                      $("#cssbody_loader").show()
                   },
...
function get_css_data(url_id, url, prefix= 'alt_'){
        ...
        $.ajax({
                      url:"<?php echo base_url(); ?>client/webperformance/uri_responce_status",
                      type:"post",
                      beforeSend:function(){
                          //$("#cssbody_loader").show()
