    ...
    <div class="row mr-0">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?= base_url('client/project/backup_db/'.$project_data->db_id)?>"><?=$this->lang->line("db_backup") ?></a></li>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="filter-container flex-row">
            ...
            <div class="flex-col-md-6 text-right"> <!-- <a class="btn btn-primary" href="http://devdemo.pro/cloud_world/client/projects/create"> New Project </a> --> </div>
          </div>
        </div>
      </div>
                      ...
                      <div id="memListTable_wrapper" class="dataTables_wrapper form-inline no-footer">
                        <div class="row">
                            ...
                            <div class="col-lg-6 text-right ftpbtn">
                              <a class="btn btn-primary" href="<?=base_url("client/backup/restore_process_db/".$backup_id)?>" ><?=$this->lang->line("restore_process") ?></a>
                            </div>
                          </div>
                          ...
                          <table id="backuplist" class="table table-bordered table-striped table-hover datatable dataTable no-footer" cellspacing="0" role="grid" aria-describedby="memListTable_info">
                            <thead>
                              <tr role="row">
                               ...
                               <th style="width: 100px;" class="sorting" tabindex="0" aria-controls="memListTable" rowspan="1" colspan="1" aria-label="Name  : activate to sort column ascending"><?=$this->lang->line("db_name") ?> </th>
                            ...
                            if(count($alldata) > 0) {
                              ...
                              foreach ($alldata as $dbs) {
                                ...
                                <td>
                                  ...
                                  ?>
								  <a href="<?=base_url("client/backup/downloaddb/".$project_data->backup_id.'/'.base64_encode($dbs->db_name));?>" class="btn btn btn-primary"><?=$this->lang->line('download') ?></a>
              ...
              swal(chk, {
                ...
                .then((value) => {
                  switch (value) {
                    ...
                    case "catch":
                        $.ajax({
                             url:"<?php echo base_url();?>client/project/putdbrestorecron",
                             type:"post",
                             beforeSend:function(){
                                $("#cover-spin").show()
                             },
