...
<span class="tooltip" title="<?=$this->lang->line("select_file_format") ?>" style="opacity: 1;"><img src="<?php echo base_url('assets/images/icons8-help-50.png');?>"> </span>
													...
													<div class="row">
														...
														<div class="col-lg-6">
															<input type="text" class="form-control" name="remote_folder" id="f_password" placeholder="/public_html" value="<?=$ftp_data->root_path?>">
														</div>
														<div class="col-lg-1">
...
<script type="text/javascript">
	$("#editftpform").on('submit', function(e){
        e.preventDefault();
    	$.ajax({
           url:"<?php echo base_url(); ?>client/project/update_ftp",
           type:"post",
           beforeSend:function(){
           		$("#cover-spin").show()
           },
