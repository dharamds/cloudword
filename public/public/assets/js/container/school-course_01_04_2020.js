var SchoolCourse = function (){
	...
	var multiselectCourse = function(){
		...
		$('#multi-select').multiSelect({
			...
			selectableHeader: "<div class='all-coures'>All courses</div><input type='text' class='form-control' style='margin-bottom: 10px;'  autocomplete='off' placeholder='Search course name'>",
			selectionHeader: "<div class='enrolled-courses'>Enrolled Courses</div><input type='text' class='form-control' style='margin-bottom: 10px;' autocomplete='off' placeholder='Search course name'>",
